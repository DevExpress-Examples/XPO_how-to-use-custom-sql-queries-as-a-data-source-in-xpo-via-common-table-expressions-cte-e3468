...
Namespace DevExpress.Xpo.DB.Cte
	Public Class MSSqlConnectionProviderWithCte
		...
		Private Function ProcessPossibleCte(ByVal maybeCteName As String) As String
			...
			Return maybeCteName
		End Function
		Public Overrides Overloads Function FormatTable(ByVal schema As String, ByVal tableName As String) As String
			Return If(ProcessPossibleCte(tableName), MyBase.FormatTable(schema, tableName))
		End Function
		Public Overrides Overloads Function FormatTable(ByVal schema As String, ByVal tableName As String, ByVal tableAlias As String) As String
			...
			End If
		End Function
		Public Overrides Overloads Function FormatSelect(ByVal selectedPropertiesSql As String, ByVal fromSql As String, ByVal whereSql As String, ByVal orderBySql As String, ByVal groupBySql As String, ByVal havingSql As String, ByVal skipSelectedRecords As Integer, ByVal topSelectedRecords As Integer) As String
